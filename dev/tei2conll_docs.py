...
for subdir, dirs, files in os.walk(corpus_directory):
    for file in files:
        ...
        with open(f'../corpus/lang/conll/sk/docs/{file.split(".")[0]}.txt', mode='w+', encoding='utf-8') as iob_file:
            ...
            with open(f'../corpus/lang/conll/sk/docs/{file.split(".")[0]}_stats.txt', mode='w+', encoding='utf-8') as txt:
                txt.write(str(stats))

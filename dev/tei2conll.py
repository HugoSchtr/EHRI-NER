...
# TODO: work on cleaner sentence segmentation to avoid having to handle exceptions (e.g. abbreviations)
...
with open(f'./iob/yi/ehri_yi.txt', mode='w+', encoding='utf-8') as iob_file:
...
with open(f'./iob/yi/ehri_yi_stats.txt', mode='w+', encoding='utf-8') as txt:
    txt.write(str(stats))